...
background-size: 900px 600px;
 ...
 <a href="OP.jsp"><button class="dropbtn">ORDERS PLACED</button></a>
  <a href="UPOO.jsp"><button class="dropbtn">UPDATE STATUS OF ORDER</button></a>
   <a href="POO.jsp"><button class="dropbtn"> VIEW STATUS OF ORDER</button></a>
  <a href="CL3.jsp"><button class="dropbtn">LOG OUT</button></a>
