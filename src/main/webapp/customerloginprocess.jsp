...
ResultSet rs=st.executeQuery("select * from cadd where cname='"+cname+"' and password='"+password+"'");

try{
rs.next();
if(rs.getString("password").equals(password)&&rs.getString("cname").equals(cname))
{
...
<div class="container">
<a href ="customerlogin.jsp" ><input type="button"  class="btn"value="back"></a></center></div>
</html>