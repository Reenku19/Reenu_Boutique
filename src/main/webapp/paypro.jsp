...
int i=st.executeUpdate("insert into payment(cid,name,email,address,city,phno,ptype)values('"+cid+"','"+name+"','"+email+"','"+address+"','"+city+"','"+phno+"','"+ptype+"')");
...
<a href="viewcart.jsp"><input type="button" class="btn"value="back"></a></div></center>
</body>
</html>
